 ...
 */
 ...
 (function(){
	...
	formatters:{
		...
		star:function(data, cell, row, options, formatterParams){
			
			var stars=$("<span style='vertical-align:middle;'></span>");

			var starActive = $('<svg width="18" height="18" viewBox="0 0 500 500" xml:space="preserve" style="margin:0 1px;"><polygon fill="white" points="10,10 10,500 500,500 500,10"/></svg>');
			
			var nextStar = starActive;
		...
		color:function(value, data, cell, row, options, formatterParams){
			...
			cell.css({"background-color":value, "padding": "10px", "background-clip": "content-box", "height": "50px",});
			return "";
		},
