...
class DataProcessing(models.Model):
    ...
    TYPEPARAM  = Choices((0, 'longitude', 'longitud [UTM29N]'),
                         ...
                         (12, 'temperature', 'temperatura interior [ºC]'),
                         (13, 'ilumination', 'iluminación [Lux]'),
                         (14, 'orientation', 'orientacion [ºDEG]'),
                         (15, 'voltage', 'voltaje [V]'),
                         (16,'amperes', 'amperios [A]'),
                         (17,'wind_mod', 'intensidad viento [m/s]'),
                         (18,'wind_dir', 'dirección viento [ºDeg]'),
                         (19,'humidity_relative', 'humedad relativa [%]')
                        )
